  ...
  return (
    <div className="space-y-4">
      <div className="card p-5">
        ...
        <p className="text-sm font-semibold text-slate-500">Ficha preparada para jugadores, estadisticas y lesiones cuando el proveedor lo entregue.</p>
      ...
      <div className="card overflow-x-auto">
        <table className="min-w-full text-sm">
          <thead className="bg-slate-50 text-left text-xs uppercase text-slate-500"><tr><th className="px-3 py-3">Jugador</th><th className="px-3 py-3">Nacionalidad</th><th className="px-3 py-3">Posicion</th><th className="px-3 py-3">Equipo</th></tr></thead>
          <tbody>
        ...
        {!isLoading && !players.length ? <div className="p-5 text-sm font-semibold text-slate-600">No disponible: jugadores no sincronizados todavia.</div> : null}
      </div>
    </div>
  )
}
